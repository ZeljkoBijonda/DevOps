Action()
{
	...
	web_add_cookie("SRCHUID=V=2&GUID=3F5A890F48354383B1EE4935F9802687&dmnchg=1; DOMAIN=iecvlist.microsoft.com");

	web_add_cookie("SRCHUSR=DOB=20180701; DOMAIN=iecvlist.microsoft.com");

	web_add_cookie("SRCHD=AF=NOFORM; DOMAIN=c.urs.microsoft.com");

	web_add_cookie("SRCHUID=V=2&GUID=3F5A890F48354383B1EE4935F9802687&dmnchg=1; DOMAIN=c.urs.microsoft.com");

	web_add_cookie("SRCHUSR=DOB=20180701; DOMAIN=c.urs.microsoft.com");
	...
	web_url("iecompatviewlist.xml", 
		...
		"Mode=HTML", 
		EXTRARES, 
		"Url=https://c.urs.microsoft.com/l1.dat?cw=636706108170730081&v=3&cv=9.11.14393.0&os=10.0.14393.0.0&pg=4A72F430-B40C-4D36-A068-CE33ADA5ADF9", "Referer=", ENDITEM, 
		LAST);
